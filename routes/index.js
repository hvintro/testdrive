...
router.post('/api/v1/preguntas', (req, res, next) => {
  ...
  respuestac:req.body.respuestac,correcta:req.body.correcta, explicacio:req.body.explicacio};
  ...
  pg.connect(connectionString, (err, client, done) => {
    ...
    client.query('INSERT INTO preguntas(pregunta, respuestaa, respuestab, respuestac, correcta, explicacio)'+
    'values($1, $2, $3, $4, $5, $6)',
    [data.pregunta, data.respuestaa, data.respuestab, data.respuestac, data.correcta, data.explicacio]);
